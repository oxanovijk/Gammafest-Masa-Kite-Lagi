"""
Feature Engineering V3 -- Gammafest Masa Kite Lagi
===================================================
Delta dari V2:
...
NOTE: Script ini MENGGANTI merge_features.py — langsung gabung core + context
"""
...
def finalize(df):
    ...
    FEATURES = [
        ...
        # Context binary
        "is_home", "is_neutral", "is_women", "is_friendly",
        # Derived
