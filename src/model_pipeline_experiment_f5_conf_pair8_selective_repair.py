...
BASE = "submission_experiment_f3_conf_pair8_stitch.csv"
OUTPUT = "submission_experiment_f5_conf_pair8_selective_repair.csv"
MIN_N = 80
...
def main() -> None:
    ...
    audit = write_audit(
        "experiment_f5_conf_pair8_selective_repair",
        OUTPUT,
        submission,
        test,
        gt,
        {
            ...
            "risk": "Aggressive local fit inherited from F3 min_n=8.",
